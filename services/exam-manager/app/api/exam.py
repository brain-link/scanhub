...
async def get_procedure(id: str) -> Any:
...
async def get_exams(patientID: str) -> Any:
    exams = await dal.get_exams(patientID)
    if not exams:
...
async def get_procedures(examID: str) -> Any:
