...
def reco(input: str):
    ...
    # ################################################################
    # # Option 2: Create DICOM
    # ################################################################

    # # Create the FileDataset instance (initially no data elements, but file_meta
    # # supplied)
    # ds = FileDataset("mri.dcm", {}, file_meta=Dataset(), preamble=b"\0" * 128)
...
app.include_router(recos, prefix='/api/v1/recos', tags=['recos'])
...
# def reco(rawmriblob: func.InputStream, blobout: func.Out[func.InputStream]):
#     logging.info(f"Python MRI Reco blob trigger function processed blob \n"
